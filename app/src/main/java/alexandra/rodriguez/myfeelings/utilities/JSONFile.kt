package alexandra.rodriguez.myfeelings.utilities
...
class JSONFile {
    ...
    fun saveData (context: Context, json:String){
        try{
            ...
            Log.e("GUARDAR", "Error is writing " + e.localizedMessage)
        }
    }
    ...
    fun getData (context: Context): String{
        try{
            ...
            Log.e("OBTENER", "Error is fetching data " + e.localizedMessage)
            return ""
        }
    }
}